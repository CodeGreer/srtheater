...
<head>
    ...
    <title>Backstage | Staged Right Theatre</title>

    <meta name="viewport" content="width=device-width, initial-scale=1">
    
    <meta name="keywords" content="backstage, theater, theatre, community, staged right, Lilburn, Gwinnett">
...
<!-- Header -->      
    <header>
        ...
        <h3 class="page_header">Backstage</h3>   
    </header>  
<!-- End Header-->
    ...
    <footer>
        ...
        <div id="menu">
            ...
            <nav>
                ...
                <a class="white" href="#">Backstage</a>
            </nav>
